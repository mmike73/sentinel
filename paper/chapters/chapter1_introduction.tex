...
\begin{enumerate}
    \item \textbf{Un motor de scoring cu trei straturi}: ponderi statice ponderate per syscall, detectare a activității în rafale cu fereastră glisantă și scorer Isolation Forest care poate fi antrenat cu date actualizate prin API REST, cu un mecanism de combinare ponderată a scorurilor care previne degradarea excesivă a scorului bazal.
    ...
    \item \textbf{O suită de 21 de scenarii de atac reproductibile}, distribuite ca artefacte de testare, care acoperă vectori de atac documentați în literatura de specialitate — de la rootkit-uri tip Diamorphine până la tehnici de execuție de cod fără fișier și rootkit-uri eBPF de tip TripleCross.
